...
var injectedOptions = {"flow": "OPT_IN", "key": "34abacb5b02b4859a57b68c481be62d1", "timeoutSeconds": 10, "scripts": {}, "frames": {}, "cookies": {}, "pixels": {"//static.ads-twitter.com/uwt.js": "C002", "https://a.quora.com/qevents.js": "C002", "https://connect.facebook.net/en_US/fbevents.js": "C002", "https://snap.licdn.com/li.lms-analytics/insight.min.js": "C002", "edge.fullstory.com/s/fs.js": "C004", "https://cdn.segment.com/analytics.js/v1": "C004", "'squarespace-common'": "C004", "'squarespace-performance'": "C004", "//www.google-analytics.com/analytics.js": "C004", "//static.hotjar.com/c/hotjar-": "C004", "ga('send'": "C004", "function gtag()": "C004"}};
...
tcModel.cmpVersion = PRIVADO_CMP_VERSION;

const privadoCmpApi = new CmpApi(PRIVADO_CMP_ID, PRIVADO_CMP_VERSION, true);
if (IS_IAB_TCF) {
      ...
      return `
        ...
        ${
          (vendor.purposes.length || vendor.cookies || vendor.features || vendor.policyUrl || vendor.deviceStorageDisclosureUrl) ?
             ...
             <div style="font-size:14px;padding-top:10px;" > Privacy Policy:<a href=${vendor.urls.find((el) => el.langId === "en").privacy || vendor.urls[0].privacy} target=_blank> ${vendor.urls.find((el) => el.langId === "en").privacy || vendor.urls[0].privacy}</a></div>
              ...
              <div style="font-size:14px;" >Device Storage Disclosure:<a href=${vendor.deviceStorageDisclosureUrl} target=_blank> ${vendor.deviceStorageDisclosureUrl}</a></div>
              </div>
              </div>
          </div>`
          : ""
